 ...
 * Funcionalidades avanzadas para el formulario de creación de usuarios
 */
...
class UserCreateManager {
  ...
  showLoadingState() {
    ...
    if (submitBtn) {
      ...
      submitBtn.innerHTML = '<i class="bx bx-loader-alt bx-spin me-1"></i> Creando...';
  ...
  static getInstance() {
    if (!UserCreateManager.instance) {
      UserCreateManager.instance = new UserCreateManager();
    }
    return UserCreateManager.instance;
  }
}
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  window.userCreateManager = UserCreateManager.getInstance();
...
window.UserCreateManager = UserCreateManager; 